          ...
          <Col xxl={4} xl={5} md={6}>
            <div className="box-template pointer-events-none animate-pulse">
              <div className="h-[340px] p-3">
                <div className="mb-2.5 h-4 max-w-[80px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[140px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[120px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[140px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[120px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[140px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[120px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                ...
                <div className="mb-2.5 h-4 max-w-[140px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[120px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
                <div className="mb-2.5 h-4 max-w-[150px] rounded-full bg-gray-100 dark:bg-gray-200"></div>
              </div>
            </div>
          </Col>
        </Row>
